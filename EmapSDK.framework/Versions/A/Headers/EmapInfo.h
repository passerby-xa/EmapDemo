...
#import "EmapLayerInfo.h"
#import "EmapLayer.h"

@class AGSTileInfo;
@protocol EmapInfoDelegate;

extern const NSUInteger EmapDefaultDPI;
...
/** 代理 */
@property (nullable, nonatomic, weak, readonly) id<EmapInfoDelegate> delegate;

/** 切片信息数组 */
@property (nullable, nonatomic, copy, readonly) NSArray<EmapLayerInfo *> *layerInfos;
 ...
 *
 *  @return EmapInfo or nil
 */
- (instancetype)initWithURLString:(NSString *)url delegate:(id<EmapInfoDelegate>)delegate;
 ...
 *  @return EmapInfo or nil
 */
- (instancetype)initWithURLString:(NSString *)url tileDPI:(NSUInteger)dpi delegate:(id<EmapInfoDelegate>)delegate;
 ...
 *  @return EmapInfo or nil
 */
- (instancetype)initWithXMLData:(NSData *)xmlData delegate:(id<EmapInfoDelegate>)delegate;
 ...
 *  @return EmapInfo or nil
 */
- (instancetype)initWithXMLData:(NSData *)xmlData tileDPI:(NSUInteger)dpi delegate:(id<EmapInfoDelegate>)delegate;
 ...
 *
 *  @return EmapLayer or nil
 */
- (nullable EmapLayer*)wmtsLayerWithLayerInfo:(EmapLayerInfo*)layerInfo;
...
@protocol EmapInfoDelegate <NSObject>
 ...
 *
 *  @param wmtsInfo EmapInfo
 */
- (void)EmapInfoDidLoad:(EmapInfo*)wmtsInfo;
 ...
 *  @param error    NSError
 */
- (void)EmapInfo:(EmapInfo*)wmtsInfo didFailToLoad:(NSError*)error;
